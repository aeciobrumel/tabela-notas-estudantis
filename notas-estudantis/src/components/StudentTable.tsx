                    ...
                    students.map(item => (
                        <tr key={item.id} className="text-gray-800 bg-gray-400 border-b border-gray-600">
                            <td className="p-3 flex items-center">
                                <img src={item.avatar} alt={item.name} className="w-20 h-20 rounded-full mr-3" />
                                <div>
                            ...
                            <td className="p-3">
                                {item.active && <div className="border-green-800 bg-green-600 text-white text-xs rounded-md inline-block px-2 py-1 ">Active</div>}
                                {!item.active && <div className="border-red-800 bg-red-600 text-white rounded-md text-xs inline-block text-center px-2 py-1">Inactive</div>}
                            </td>
